  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="tech.php" target="_self">Techincal</a></li>
    ...
    <div class="col-sm-9">
      <hr>
      <center>
<div class="title">Technical Quiz of the Day</div>
<?php
...
$qrry = "INSERT INTO result (username,score,description,quizdate) VALUES('$a','$b','$c','$date') ";
mysqli_query($con,$qrry);
